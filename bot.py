...
async def love(ctx, member: discord.Member = None):
    ...
    embed.set_thumbnail(url="https://img.freepik.com/photos-gratuite/forme-coeur-3d-couple-amoureux_23-2150965335.jpg?t=st=1741155852~exp=1741159452~hmac=269bf57afed5bd664832de5febc63dc88f2f96734ce329d2ad2046cfbc771c70&w=826")  # Image que tu veux dans l'embed (personnalisable)
